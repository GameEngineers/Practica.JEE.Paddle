...
public class CourtResource {
	...
	public void createCourt(@RequestParam(required = true) int id)
			throws AlreadyExistCourtIdException {
	...
	public void changeCourtActivationTrue(@PathVariable int id)
			throws NotFoundCourtIdException {
